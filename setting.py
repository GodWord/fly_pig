...
CREATE TABLE `xb_company_position_1` (
  ...
  `description` varchar(5000) DEFAULT NULL COMMENT '岗位描述',
  `job_requirements` varchar(5000) DEFAULT NULL COMMENT '任职要求',
  `work_nature` varchar(20) DEFAULT NULL COMMENT '工作性质',
  `recruit_num` char(11) DEFAULT NULL COMMENT '招聘人数',
...
CREATE TABLE `xb_company_1` (
  ...
  `logo` varchar(100) DEFAULT 'http://xiaobaijob.com/res/img/7974354903424c85aec99526f57a3dd4.png' COMMENT '企业LOGO',
...
DB_CONNS = {
    'default': lambda: pymysql.connect(host="localhost", port=3306, user="root",
                                       password="admin", db="crawler_db", charset='utf8mb4'),
}
TABLE_CONFIG = {
...
ZHILIAN_CONFIG = {
    ...
    'page_size': 5,
    'url': """
    https://fe-api.zhaopin.com/c/i/sou?pageSize=60&cityId=765&industry=10100&workExperience=-1&education=5&companyType=-1&employmentType=2&jobWelfareTag=10000&kw=%E6%B5%8B%E8%AF%95%E5%B7%A5%E7%A8%8B%E5%B8%88&kt=3&_v=0.60109471&x-zp-page-request-id=3eec9ef4870042dd8ea7849eb4ffd107-1543648000193-719347 
    """,
    'keyword': '互联网'
}
